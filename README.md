...
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/klZNog2ow2uGuFNMvk8mAQ "explain to anyone"),  **without the help of Google**:
...
Write a function that checks if a binary tree is a valid  [Binary Search Tree](https://intranet.hbtn.io/rltoken/L2CpULSk9hQEOBKaGI8IkQ "Binary Search Tree")
...
Write a function that checks if a binary tree is a valid  [AVL Tree](https://intranet.hbtn.io/rltoken/zawOf_VUKC0zTBPbKFv4Vg "AVL Tree")
...
Write a function that checks if a binary tree is a valid  [Max Binary Heap](https://intranet.hbtn.io/rltoken/St8ewcG2JJuWmkSNTfe29g "Max Binary Heap")
